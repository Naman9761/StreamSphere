...
const Home = ({isAuthenticated})=> {
  ...
  return (
    <>
      ...
      <div className="container-fluid">
        <div className={`navbar-header`}>
          ...
          <a className={`${styles.navbarBrand} navbar-brand`} href="#">StreamSphere</a>
        </div>
      ...
      <div className={styles.bannerTitle}>
        <h1 className={styles.bannerHead}>Enjoy free  video calls</h1>
        <p className={styles.bannerLead}>StreamSphere is a high quality video calling app. It's free and works on the web.</p>
        <br/>
    ...
    <div className={styles.headline}>What can you do with StreamSphere?</div>
    ...
    <div className={styles.reminder}>
      ...
      <Button title="Try StreamSphere now" onClickHandler={onTryNowBtnClick}/>
    </div>
    <div className={styles.footer}>
    <a className={`${styles.navbarBrand}`} href="#">StreamSphere</a>
    <p className={styles.footerText}>Copyright© 2021 StreamSphere. All rights reserved.</p>
    </div>
    </HomeLayout>
    </>
  )
